...
public class SimaRecibos implements java.io.Serializable {
    ...
    public SimaRecibos(String sFile) {
...
public void registro(String codigo) {

          seek(codigo);

          System.out.println("-----------------------Registro No." + getNIDECODRFA()+"-----------------------");
